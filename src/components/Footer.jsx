    ...
    <div style={{height:'300px'}} className='d-flex justify-content-center align-items-center w-100 flex-column'>
      <div className='d-flex justify-content-evenly align-items-center w-100'>
        <div className="websites" style={{width:'400px'}}>
          ...
          <h6>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolores ut reiciendis expedita reprehenderit illo autem illum optio nihil quaerat dolorem, </h6>
          <h6>accusamus a ea quod similique nisi ex impedit amet voluptate?</h6>
        </div>
