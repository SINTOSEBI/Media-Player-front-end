...
function VideoCard({displayVideo , setDeleteVideoStatus ,isPresent}) {
  ...
  //function todrag a particular card

  const dragStart = (e,id)=>{
    console.log(`card that dragged is :${id}`);
    //to tarnsfer id from videocard to category
     ...
     onHide={handleClose}
      backdrop="static"
       keyboard={false}>
        ...
        <Modal.Body><iframe width="100%" height="530" src={`${displayVideo.embedLink}? autoplay=1`} title={displayVideo.caption}  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe></Modal.Body>
